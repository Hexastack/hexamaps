  ...
  return {
    ...
    render: function (createElement) {
      return createElement(
        "g",
        { class: "hm-entity-box", attrs: { transform: this.transform } },
        [
          createElement("path", {
            class: "hm-entity",
          ...
          children.map((child) => {
            const entityComponents = child(
              this,
              {
                inputs: this[child.pluginName + "EntityIn"],
                outputs: this[child.pluginName + "EntityOut"],
                data: this[child.pluginName + "Entity"],
              },
              {
            ...
            return entityComponents.map((entityComponent) =>
              createElement(entityComponent.component, {
                props: entityComponent.props,
              })
            );
          }),
        ]
    ...
    methods: {
      ...
      click(e) {
        if (this.$root.$options.editor) this.$emit("selectedCountry", this);
